let peoples = [{"id":1,"firstName":"Osmond","surName":"Kieran","sex":"Male","age":26,"isVegetarian":true,"langCount":8},
...
document.getElementById('men').innerText = textCountMen;
document.getElementById('women').innerText = textCountWomen;
